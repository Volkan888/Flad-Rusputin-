ALTER TABLE matches
    ADD COLUMN IF NOT EXISTS timer_preset text NOT NULL DEFAULT 'live_standard';
...
ALTER TABLE matches
    ...
    CHECK (timer_preset IN ('live_quick','live_standard','live_extended','async_12h','async_24h','async_48h'));
